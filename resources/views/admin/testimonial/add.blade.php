      ...
      <div class="card">
        <div class="card-header card_header bg-dark">
          <div class="row">
            <div class="col-md-8 card_header_title">
              <i class="fab fa-gg-circle"></i>Add Testimonial Information</div>
            <div class="col-md-4 card_header_btn">
              <a class="btn btn-sm btn-secondary chb_btn" href="{{ url('dashboard/testimonial') }}"><i class="fas fa-bars"></i> All Testimonial</a>
            </div>
          </div>
        </div>
        <div class="card-body card_body">
          ...
          <div class="row mb-3 {{$errors->has('test_name') ? 'has-error':''}}">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control form_control" name="test_name" value="{{ old('test_name') }}">
          ...
          <div class="row mb-3 {{$errors->has('test_designation') ? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control form_control" name="test_designation" value="{{ old('test_designation') }}">
          ...
          <div class="row mb-3 {{$errors->has('test_company') ? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <input input="text" class="form-control form_control" name="test_company" value="{{ old('test_company') }}">
          ...
          <div class="row mb-3 {{$errors->has('test_order') ? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <input input="text" class="form-control form_control" name="test_order" value="{{ old('test_order') }}">
          ...
          <div class="row mb-3 {{$errors->has('test_feedback') ? ' has-error':''}}">
            ...
            <div class="col-sm-7">
                <textarea type="text" class="form-control form_control" name="test_feedback" value="{{ old('test_feedback') }}" cols="20" rows="5"></textarea>
