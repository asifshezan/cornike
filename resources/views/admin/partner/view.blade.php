          ...
          <div class="card-header card_header bg-dark">
            <div class="row">
              <div class="col-md-8 card_header_title">
                <i class="fab fa-gg-circle"></i>Partner Information</div>
              <div class="col-md-4 card_header_btn">
                <a href="{{url('dashboard/partner')}}" class="btn btn-sm btn-secondary chb_btn"><i class="fas fa-th"></i> All Partner</a>
              </div>
            </div>
          </div>
